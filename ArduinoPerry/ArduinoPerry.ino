...
/*
  ...
  Aba 1 - Isurus    : Aqui estão as configurações iniciais, os parametros que são utilizados no PID e o cabeçalho das funções utilizadas
...
const int PINSENSORS[SENSORS] = {14, 15, 16, 17}; //No arduino Nano isso seria igual a = {A0, A1, A2, A3};
...
#define PININ1 6 //Pino 1 de controle de sentido do motor esquerdo
#define PININ2 7 //Pino 2 de controle de sentido do motor esquerdo
#define PININ3 8 //Pino 1 de controle de sentido do motor direito
#define PININ4 9 //Pino 2 de controle de sentido do motor direito
...
#define LEFTDEADBAND 0//Zona morta do motor esquerdo
#define RIGHTDEADBAND 0//Zona morta do motor direito
...
int calibrationMinS[SENSORS] = {0, 0, 0, 0}; //Leitura maxima possivel para cada sensor
int calibrationMaxS[SENSORS] = {1023, 1023,  1023,  1023}; //Leitura minima possivel para cada tcrt
